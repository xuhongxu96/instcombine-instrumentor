...
On load, `readInitialIr` prefers `irz` (async-decoded after mount) over `ir`. The webapp is instrumented with a privacy-light GoatCounter snippet in `web/index.html`.
